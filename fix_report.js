...
if (idx !== -1) {
  // Go back to before the broken line to get a clean cut
  const before = content.substring(0, idx);
  // Find the last newline before the broken marker
...
console.log('File fixed successfully. New length:', (content + tail).split('\n').length, 'lines');
