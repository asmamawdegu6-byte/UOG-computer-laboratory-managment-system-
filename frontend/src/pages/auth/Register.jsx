...
// University of Gondar campuses
const CAMPUSES = [
  { value: 'Tewodros', label: 'Tewodros Campus' },
  { value: 'Maraki', label: 'Maraki Campus' },
  { value: 'Fasil', label: 'Fasil Campus' },
  { value: 'GC', label: 'GC Campus' }
];
        ...
        <div className="error-message">
          ...
          {existingAccount && (
            <div className="existing-account-actions">
              <p>This account already exists. Would you like to login instead?</p>
              <Button
                type="button"
                variant="secondary"
                size="medium"
