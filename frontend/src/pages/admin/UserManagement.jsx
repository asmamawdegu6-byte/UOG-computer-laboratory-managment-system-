    ...
    const handleSubmit = async (e) => {
        ...
        try {
            if (modalMode === 'add') {
                ...
                // Only send fields the backend updateUser controller accepts
                const updateData = {};
                    ...
                    <form className="user-form" onSubmit={handleSubmit}>
                        <div className="form-row">
                            ...
                            <div className="form-group">
                                ...
                                <input name="username" value={formData.username} onChange={handleFormChange} required minLength={3} disabled={modalMode === 'edit'} />
                            </div>
                        </div>
                        <div className="form-row">
                            <div className="form-group">
                            ...
                            {modalMode === 'add' && (
                                <div className="form-group">
                                    ...
                                    <input name="password" type="password" value={formData.password} onChange={handleFormChange} required minLength={6} />
                                </div>
                            )}
                        </div>
                        <div className="form-row">
                        ...
                        <div className="form-row">
                            <div className="form-group">
                                ...
                                <input name="studentId" value={formData.studentId} onChange={handleFormChange} />
                            </div>
                            <div className="form-group">
                                <label>Phone</label>
                    ...
                    {viewingUser && (
                        <div className="detail-view">
                            <div className="detail-header">
                                <div className="user-avatar-large">{viewingUser.name?.charAt(0)}</div>
