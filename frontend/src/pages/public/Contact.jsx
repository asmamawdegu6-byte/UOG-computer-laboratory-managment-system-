...
// Default hero image
const CONTACT_HERO = 'https://images.unsplash.com/photo-1523050854058-8df90110c9f6?w=1920&auto=format&fit=crop&q=80';

// Contact card images
const CONTACT_IMAGES = {
    address: 'https://images.unsplash.com/photo-1562774053-701939374585?w=400&q=80',
    phone: 'https://images.unsplash.com/photo-1559757175-5700dde675bc?w=400&q=80',
    email: 'https://images.unsplash.com/photo-1596526131083-e8c633c948d2?w=400&q=80',
    hours: 'https://images.unsplash.com/photo-1506784983877-45594efa4cbe?w=400&q=80'
};

// FAQ images
const FAQ_IMAGES = {
    booking: 'https://images.unsplash.com/photo-1517694712202-14dd9538aa97?w=400&q=80',
    hours: 'https://images.unsplash.com/photo-1506784983877-45594efa4cbe?w=400&q=80',
    fault: 'https://images.unsplash.com/photo-1587620962725-abab7fe55159?w=400&q=80',
    cancel: 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=400&q=80'
};
...
const Contact = () => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        // Using mailto for form submission
        const mailtoLink = `mailto:asmedeg2888@gmail.com?subject=${encodeURIComponent(formData.subject)}&body=${encodeURIComponent(`Name: ${formData.name}\nEmail: ${formData.email}\n\nMessage:\n${formData.message}`)}`;
    ...
    const contactCards = [
        {
            ...
            icon: '📍',
            title: 'Address',
            content: 'University of Gondar, Gondar, Ethiopia',
    ...
    const emergencyContacts = [
        { id: 1, title: 'Technical Support', phone: '+251 47 77 28 87', icon: '🔧', available: '24/7' },
        { id: 2, title: 'Lab Manager', phone: '+251 28 88 63 41', icon: '👨‍💼', available: '8AM-5PM' },
        { id: 3, title: 'Security', phone: '+251 47 77 28 87', icon: '🛡️', available: '24/7' }
    ];
    ...
    return (
        <div className="home-page">
            {/* Hero Section */}
            <section className="contact-hero" style={{ backgroundImage: `url(${CONTACT_HERO})` }}>
                <div className="hero-overlay"></div>
                <div className="hero-content">
                    <span className="hero-badge">University of Gondar</span>
                    <span className="campus-focus-tag">Computer Lab Management</span>
                    <h1>Contact Us</h1>
                    <p>Get in touch with us for any questions or support</p>
                    <div className="hero-actions">
                        <Link to="/login" className="btn-hero-primary">Get Support</Link>
                        <Link to="/services" className="btn-hero-secondary">View Services</Link>
                    </div>
                </div>
            </section>
            ...
            <section className="contact-main-section">
                <div className="contact-container">
                    ...
                    <div className="contact-form-wrapper">
                        ...
                        <p className="form-subtitle">We'll respond to: <strong>asmedeg2888@gmail.com</strong></p>
                    ...
                    <div className="map-wrapper">
                        ...
                        <div className="map-container">
                            <img 
                                ...
                                alt="University of Gondar Location" 
                                className="map-image"
                            />
