      ...
      <nav className="home-nav">
        <div className="nav-brand">
          ...
          <svg className="nav-logo" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
            {/* Outer circle - university emblem */}
            <circle cx="100" cy="100" r="95" fill="#1a237e" stroke="#fbbf24" strokeWidth="3"/>
            <circle cx="100" cy="100" r="88" fill="none" stroke="#fbbf24" strokeWidth="1"/>
            {/* Inner decorative ring */}
            <circle cx="100" cy="100" r="82" fill="none" stroke="#fbbf24" strokeWidth="0.5" strokeDasharray="3,2"/>
            {/* Book / Knowledge symbol */}
            <path d="M70 75 L100 60 L130 75 L130 120 L100 130 L70 120 Z" fill="#fbbf24" opacity="0.9"/>
            <path d="M100 60 L100 130" stroke="#1a237e" strokeWidth="1.5"/>
            <line x1="78" y1="80" x2="96" y2="72" stroke="#1a237e" strokeWidth="1"/>
            <line x1="78" y1="88" x2="96" y2="80" stroke="#1a237e" strokeWidth="1"/>
            <line x1="78" y1="96" x2="96" y2="88" stroke="#1a237e" strokeWidth="1"/>
            <line x1="104" y1="72" x2="122" y2="80" stroke="#1a237e" strokeWidth="1"/>
            <line x1="104" y1="80" x2="122" y2="88" stroke="#1a237e" strokeWidth="1"/>
            <line x1="104" y1="88" x2="122" y2="96" stroke="#1a237e" strokeWidth="1"/>
            {/* Star on top */}
            <polygon points="100,30 104,42 117,42 107,50 111,63 100,55 89,63 93,50 83,42 96,42" fill="#fbbf24"/>
            {/* University text */}
            <text x="100" y="155" textAnchor="middle" fontSize="14" fontWeight="bold" fill="white" fontFamily="serif">UNIVERSITY</text>
            <text x="100" y="172" textAnchor="middle" fontSize="14" fontWeight="bold" fill="white" fontFamily="serif">OF GONDAR</text>
            {/* Decorative dots around the circle */}
            {[...Array(24)].map((_, i) => {
              const angle = (i * 15) * Math.PI / 180;
              const x = 100 + 92 * Math.cos(angle);
              const y = 100 + 92 * Math.sin(angle);
              return <circle key={i} cx={x} cy={y} r="1.5" fill="#fbbf24" opacity="0.6"/>;
            })}
          </svg>
